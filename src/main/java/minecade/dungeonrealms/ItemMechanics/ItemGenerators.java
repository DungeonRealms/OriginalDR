...
public class ItemGenerators {
    ...
    // Mob gear armor stuff
    public static ItemStack MobChestPlateGenerator(int tier, int mob_tier_level) {
        Random r = new Random();
        Material m = null;
        ...
        if ((mob_tier_level == 3 && armor_range_check > 90) || (mob_tier_level == 4 && armor_range_check > 55 && armor_range_check < 95)) {
        ...
        if(mob_tier_level == 4 && armor_range_check >= 95){
    ...
    public static ItemStack MobHelmetGenerator(int tier, boolean reroll, ItemStack original, int mob_level_tier) {
        Random r = new Random();
        Material m = null;
        boolean hp_regen = false, /* hp_increase = false, */energy_regen = false, block = false, dodge = false, thorns = false, reflection = false, gem_find = false, item_find = false;
        int hp_regen_percent = 0;
        ...
        if ((mob_level_tier == 3 && armor_range_check > 90) || (mob_level_tier == 4 && armor_range_check > 55 && armor_range_check < 95)) {
        ...
        if(mob_level_tier == 4 && armor_range_check >= 95){
            rarity = ChatColor.YELLOW.toString() + ChatColor.ITALIC.toString() + "Unique";
            if (tier == 1) {
                int min_num = 1 + 1;
                int max_num = 2 + 1;
    ...
    public static ItemStack MobLeggingsGenerator(int tier, boolean reroll, ItemStack original, int mob_level_tier) {
        Random r = new Random();
        Material m = null;
        boolean hp_regen = false, /* hp_increase = false, */energy_regen = false, block = false, dodge = false, thorns = false, reflection = false, gem_find = false, item_find = false;
        int hp_regen_percent = 0;
    ...
    public static ItemStack MobBootGenerator(int tier, boolean reroll, ItemStack original, int mob_level_tier) {
        Random r = new Random();
        Material m = null;
