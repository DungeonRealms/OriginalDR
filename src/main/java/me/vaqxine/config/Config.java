...
public class Config {
    ...
    public static final String Hive_IP = "72.20.40.38";

    public static final int SQL_port = 7447;
    public static final String sql_user = "slave_3XNZvi";
    public static final String sql_password = "SgUmxYSJSFmOdro3";
    ...
    public static final String ftp_pass = "9bgsMKsknkJ6OY"; 
