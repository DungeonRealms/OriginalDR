...
public class GuildMechanics implements Listener {
	...
	public static ItemStack guild_emblem = ItemMechanics.signCustomItem(Material.EYE_OF_ENDER, (short)1, ChatColor.DARK_AQUA.toString() + ChatColor.BOLD.toString() + "Guild Emblem", ChatColor.GRAY.toString() + "Guild:" + ChatColor.GRAY.toString() + " Legendary Heroes" + ","
